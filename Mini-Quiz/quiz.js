const quesJSON = [
  ...
  {
    correctAnswer: "Atlanat United",
    options: ["Atlanta United", "Atlanta Impact", "Atlanta Bulls", "Stars"],
...
function showQuestion() {
  ...
  //setting questio text content
  questionEl.textContent = question;
  const shuffledOptions = shuffleOptions(options);

  //Populating the options div with the buttons
  shuffledOptions.forEach((opt) => {
    //creating buttons and appending it to the options div
